...
const Home = () => {
  ...
  return (
    <>
      ...
      <Container
        fluid
        className="min-vh-100 d-flex align-items-center justify-content-center p-4 home-wrapper"
      >
        <div
          className="shadow rounded w-100 home-container"
        ...
        >
          <Row className="align-items-stretch">
                ...
                >
                  <div>
                    {!isLoggedIn ? (
                      <>
                        <h2>
                          Welcome to <span className="text-primary">EduFund</span>
                        </h2>
                        <p className="text-muted">
                          Empower your financial journey with a secure and
                          intuitive platform built for students
                        </p>
                      </>
                    ) : (
                      <>
            ...
            <Col
              md={6}
              className="feature-pane d-flex flex-column justify-content-center"
            >
